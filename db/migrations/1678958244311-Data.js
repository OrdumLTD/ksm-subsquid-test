module.exports = class Data1678958244311 {
    name = 'Data1678958244311'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "treasury" ("id" character varying NOT NULL, "prop_index" text, CONSTRAINT "PK_55655557260341eb45eb7306810" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_ff6399977646384d93e015b586" ON "treasury" ("prop_index") `)
        await db.query(`CREATE TABLE "proposals" ("id" character varying NOT NULL, CONSTRAINT "PK_db524c8db8e126a38a2f16d8cac" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_ff6399977646384d93e015b586"`)
